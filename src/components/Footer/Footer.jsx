...
function Footer() {
    ...
    return (
        <footer className="bg-[#242528] w-[100vw] flex flex-col items-center py-8 text-white md:text-[0.8rem] lg:text-[0.9rem]">
            <button className={`fixed bottom-[20px] right-[20px] flex justify-center items-center hover:bg-[#79F4E4] bg-[white] text-white border-none rounded-full w-[40px] h-[40px] text-[16px] cursor-pointer z-[1000] ${isVisible ? `flex` : `hidden`} md:right-[35px] md:bottom-[35px] lg:right-[50px] lg:bottom-[50px]`}
                onClick={scrollToTop}
            >
